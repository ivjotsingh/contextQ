import { FileText, Trash2, FileType, Clock, Layers } from 'lucide-react';
...
export function DocumentList({ documents, onDelete, isLoading }) {
  if (isLoading) {
    return (
      ...
      {documents.map((doc, index) => (
        ...
        >
          ...
          <div className={`w-10 h-10 rounded-xl flex items-center justify-center text-lg ${
            FILE_COLORS[doc.document_type] || FILE_COLORS.txt
          }`}>
